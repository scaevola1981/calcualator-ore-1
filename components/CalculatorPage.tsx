  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <SettingsGroup>
          <SettingsRow>
            <label htmlFor="hourlyRate" className="text-gray-900 flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                min="0"
                step="any"
                className="w-24 bg-gray-100 text-gray-900 text-right rounded-lg px-2 py-1 border-none focus:ring-2 focus:ring-blue-500 focus:outline-none"
              />
              <span className="text-gray-500 font-medium">{currencySymbols[currency]}</span>
            </div>
          </SettingsRow>
        </SettingsGroup>
        <SettingsGroup>
          <SettingsRow>
            ...
            <div className="bg-gray-200 p-1 rounded-lg flex items-center text-sm font-semibold">
