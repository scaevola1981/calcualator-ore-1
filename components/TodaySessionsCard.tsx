...
export const TodaySessionsCard: React.FC<TodaySessionsCardProps> = ({ sessions }) => {
  return (
    <div className="bg-white dark:bg-zinc-900 p-4 rounded-xl shadow-sm">
       <div className="mb-2">
         <p className="text-lg font-semibold text-gray-900 dark:text-white">Sesiuni Azi</p>
       </div>
       {sessions.length > 0 ? (
          ...
          <div className="text-center py-4">
            <ListChecks className="w-8 h-8 mx-auto text-gray-400 dark:text-zinc-500 mb-2" />
            <p className="text-sm text-gray-500 dark:text-zinc-400">Nicio sesiune finalizată azi.</p>
          </div>
       )}
    </div>
  );
